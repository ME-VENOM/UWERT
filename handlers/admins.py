...
@Client.on_message(command(["مؤقتا", "rukja"]) & other_filters)
@errors
...
@Client.on_message(command(["كمل"]) & other_filters)
@errors
@authorized_users_only
...
async def stop(_, message: Message):
    ...
    await message.reply_text("» حصل {} ".format(
